...
public class _02_PasswordChecker implements KeyListener {
     ...
     */
    static final String regexCriteria5 = "[^2]";
    ...
    static final String CRITERIA5 = "Cannot contain the letter 2";
    ...
    public _02_PasswordChecker() {
        ...
        criterias.add(new Criteria(CRITERIA5, regexCriteria5, USE_FIND));
